...
or set it in the Nautilus scripts folder to make it appear in the context menu (recommended).

**Workflow**
- Right click on the folder you want to upload as a repo.
...
Tested on Pop!_OS only (using Nautilus).
